...
\begin{table}
    ...
    \begin{tabular}{lrrlrr}
        \toprule
        dataset & n & dim & matroid & rank & outliers \\
        \midrule
        \higgs & 11\,000\,000 & 7 & Partition & 20 & 1\,306 \\ 
        \phones & 13\,062\,475 & 3 & Partition & 35 & 1\,100\\ 
        \wiki & 4\,976\,753 & 10 & Transversal & 50 & 50 \\ 
        \bottomrule
    \end{tabular}
\end{table}
\paragraph*{Datasets}
...
For each dataset, the maximum number of allowed outliers is reported in Table~\ref{tab:datasets}.
...
\begin{figure}
    \includegraphics[width=\columnwidth]{seq-effect}
    \caption{
...
\begin{figure}
    \includegraphics[width=\columnwidth]{seq-time}
    \caption{
        \label{fig:seq-time}
